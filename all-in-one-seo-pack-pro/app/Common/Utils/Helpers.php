...
class Helpers {
	...
	public function sendRequest( $url, $body = [], $headers = [] ) {
		if ( $url === 'https://licensing.aioseo.com/v1/activate/' || $url === 'https://licensing.aioseo.com/v1/addons/' ) {
			return json_decode( '{"success":true,"product_id":"1415b451be1a13c283ba771ea52d38bb","all_activations":["localhost"],"key":"1415b451be1a13c283ba771ea52d38bb","level":"business","expires":"2023-01-01 00:00:00","counts":{"total":99,"used":0,"remaining":99,"local":1}}' );
		}
